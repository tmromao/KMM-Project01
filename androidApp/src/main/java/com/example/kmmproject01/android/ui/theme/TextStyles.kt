...
import com.example.kmmproject01.android.ui.theme.FontTypes.ttOpenSansCondensedRegular
import com.example.kmmproject01.resources.FontSizingResource
...
// USANDO OS ESTILOS PERSONALIZADOS NA TIPOGRAFIA DO ANDROID App


// 3) USANDO OS ESTILOS PERSONALIZADOS NA TIPOGRAFIA DO ANDROID
val typography = Typography(
    defaultFontFamily = ttOpenSansCondensedRegular.toFontFamily(),
    h1 = TextStyles.h1,
    h2 = TextStyles.h2,
    h3 = TextStyles.h3,
    h4 = TextStyles.h4,
...
abstract class TextStyleDefinitions(
    ...
    companion object {
        fun getBoldTextStyle(
            ...
            fontFamily = ttOpenSansCondensedRegular.toFontFamily(),
            fontWeight = ttOpenSansCondensedRegular.weight,
            fontStyle = ttOpenSansCondensedRegular.style,
